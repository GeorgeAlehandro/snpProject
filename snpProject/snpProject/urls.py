...
from snpProjectDB.views import homepage, snppage, genespage, DiseasesListView, show_diseases, show_snps,test, SNPListView, show_snp_result, SNPToDiseaseToReferenceListView, show_snptodiseasetoref_result,show_genes_snptodiseasetoref_result, diseasespage, docs_mainpage, show_references_result,ReferencesListView, docs_faqpage
