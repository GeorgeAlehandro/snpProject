...
from snpProjectDB.views import homepage, snppage, genespage, DiseasesListView, show_diseases, show_snps, SNPListView, formsearch, snpresult, show_snp_result, SNPToDiseaseToReferenceListView, show_snptodiseasetoref_result
...
urlpatterns = [
    ...
    re_path(r'genes/', show_snptodiseasetoref_result),
